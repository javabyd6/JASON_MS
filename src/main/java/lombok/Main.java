...
public class Main {
    public static void main(String[] args) {
        ...
        Student student1 = new Student("Geniu", "Kowalski", new Address("Bydgoszcz", "Pestalozziego"));
        Student student2 = new Student ("Waldek","Janicki", new Address("Bydgoszcz","Lelewela"));
